...
// Add this utility function to format large numbers
formatNumber(num) {
    if (num >= 1e12) {
    ...
    async fetchStats() {
        ...
        this.stats.totalSpent = this.formatNumber(totalSpentAmount);
...
PurchaseChart.template = "purchase_dashboard.purchase_chart";
