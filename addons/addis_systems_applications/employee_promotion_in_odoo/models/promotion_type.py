...
class DemotionType(models.Model):
    """This model is used for the Demotion Type of Employee"""
    _name = 'demotion.type'
    _description = 'Demotion Type'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _rec_name = 'demotion_type'

    demotion_type = fields.Text(string='Demotion Type', help='Demotion type')